...
constexpr std::string_view kLowercaseChars = "abcdefghijklmnopqrstuvwxyz0123456789~!@#$%^&*()\n\r\t\v\b\a;:\"\'\\/,.";
...
TEST(StrIcases, Hash) {
    ...
    EXPECT_EQ(hash(std::string_view("WARNING")), hash(std::string_view("warning")));
}
...
TEST(StrIcases, CompareEqual) {
    ...
    EXPECT_FALSE(utils::StrIcaseEqual{}(std::string_view("\1", 1), std::string_view("\33", 1)));
    EXPECT_FALSE(utils::StrIcaseEqual{}(std::string_view("\2", 1), std::string_view("\34", 1)));
    EXPECT_FALSE(utils::StrIcaseEqual{}(std::string_view("\3", 1), std::string_view("\35", 1)));
    EXPECT_FALSE(utils::StrIcaseEqual{}(std::string_view("\4", 1), std::string_view("\36", 1)));
    EXPECT_FALSE(utils::StrIcaseEqual{}(std::string_view("\5", 1), std::string_view("\37", 1)));
    EXPECT_FALSE(utils::StrIcaseEqual{}(std::string_view("\6", 1), std::string_view("\38", 1)));
...
TEST(StrIcases, CompareLess) {
    ...
    EXPECT_TRUE(utils::StrIcaseLess{}(std::string_view("\0bc", 3), std::string_view("abc", 3)));
    EXPECT_TRUE(utils::StrIcaseLess{}(std::string_view("\0bc", 3), std::string_view("ab", 2)));
}
